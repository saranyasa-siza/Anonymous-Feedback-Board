...
export type ImpureCircuits<PS> = {
  submitFeedback(context: __compactRuntime.CircuitContext<PS>,
                 newFeedback_0: string): __compactRuntime.CircuitResults<PS, []>;
  removeFeedback(context: __compactRuntime.CircuitContext<PS>): __compactRuntime.CircuitResults<PS, string>;
}
...
export type Ledger = {
  ...
  readonly feedback: { is_some: boolean, value: string };
